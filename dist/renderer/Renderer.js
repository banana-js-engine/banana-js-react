...
var _VertexArray = require("./VertexArray");
class QuadVertex {
  position = null;
  color = null;
  texCoords = null;
...
class Renderer {
  ...
  constructor(gl) {
    ...
    this.#renderData.quadVAO = new _VertexArray.VertexArray(this.#gl);
    ...
    this.#renderData.lineVAO = new _VertexArray.VertexArray(this.#gl);
    ...
    this.#renderData.meshVAO = new _VertexArray.VertexArray(this.#gl);
  ...
  drawParticle(particle, dt) {
    ...
    if (particle.bornParticleCount < particle.maxCount) {
      particle.bornParticleCount = Math.min(particle.maxCount, Math.floor(particle.bornParticleCount + particle.birthRate * dt));
    }
  ...
  drawTilemap(tilemapComponent) {
    ...
    const currentPosition = _Vector.Vector3.zero;
